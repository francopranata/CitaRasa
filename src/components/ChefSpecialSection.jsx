        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-cream-50 rounded-lg shadow-xl overflow-hidden grid lg:grid-cols-2 items-center">
                ...
                <div className="h-80 lg:h-full w-full order-1 lg:order-2 overflow-hidden">
                    ...
                    <img src="/src/assets/ChefSpecialSection/NasiGorengWarisan.png" alt="Nasi Goreng Warisan" className="w-full h-full object-cover transition-transform duration-500 hover:scale-110"/>
                </div>
            </div>
        </div>
    </SectionWrapper>
